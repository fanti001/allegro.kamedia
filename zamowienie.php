...
$potwierdzenie['efekt']             = (preg_match('#^(grayscale|sepia)/[a-z0-9_]+/[a-z0-9_\-]+(\.jpe?g)?$#i', $_POST["efekt"], $match)) ? $match[1] : 'pe≈Çny kolor';
...
$mail->Subject = "WiadomoúÊ z konfiguratora Allegro.Kamedia.pl";
